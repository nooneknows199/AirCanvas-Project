...
hands = mpHands.Hands(False, 1, 0.65, 0.5)#min_detection_confidence=0.5, min_tracking_confidence=0.5)
        ...
        if len(lmLst) != 0:
            ...
            if y1 < 125:
                ...
                if (t < 0):
                    ...
                    avgX = (tX + iX ) // 2 #tX + int(10/100*((tX + iX ) // 2))
                    avgY = (tY + iY ) // 2 #tY + int(10/100*((tY + iY ) // 2))
                    cv.circle(img, (avgX, avgY), 15, color , cv.FILLED)
                    ...
                    cv.line(img, (xx1,yy1),(x1,y1), color, 5)
                    cv.line(canvas, (xx1,yy1),(x1,y1), color, 5)
